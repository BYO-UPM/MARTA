...
# python MARTA-S_classifier.py --fold $FOLD --gpu 0 --latent_dim 64 --domain_adversarial 1 --cross_lingual testing_neurovoz &
# PID_GPU1=$!  
# python MARTA-S_classifier.py --fold $FOLD --gpu 1 --latent_dim 64 --domain_adversarial 1 --cross_lingual testing_gita &
# PID_GPU2=$!
# wait $PID_GPU1
# wait $
python hubert_classifier.py --fold $FOLD --experiment testing_gita --gpu 0 &
PID_GPU0=$!
python hubert_classifier.py --fold $FOLD --experiment testing_neurovoz --gpu 1 &
PID_GPU1=$!
wait $PID_GPU0
wait $PID_GPU1
